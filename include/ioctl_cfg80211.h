...
#define rtw_wdev_invit_info_init(invit_info) \
	do { \
		...
		set_zero_mac_addr((invit_info)->peer_mac); \
...
#define rtw_wdev_nego_info_init(nego_info) \
	do { \
		...
		set_zero_mac_addr((nego_info)->peer_mac); \
...
#define wdev_to_priv(w) container_of(w, struct rtw_wdev_priv, rtw_wdev)

#define wiphy_to_adapter(x) (((struct rtw_wdev_priv*)wiphy_priv(x))->padapter)

#define wiphy_to_wdev(x) (&(((struct rtw_wdev_priv*)wiphy_priv(x))->rtw_wdev))
