...
void rtl8188e_free_hal_data(PADAPTER padapter);
void rtl8188e_read_chip_version(PADAPTER padapter);
void rtl8188e_EfusePowerSwitch(PADAPTER pAdapter, u8 bWrite, u8 PwrState);
void rtl8188e_ReadEFuse(PADAPTER Adapter, u8 efuseType, u16 _offset, u16 _size_byte, u8 *pbuf, BOOLEAN bPseudoTest);
int rtl8188e_EFUSE_GetEfuseDefinition(PADAPTER pAdapter, u8 efuseType, u8 type, BOOLEAN bPseudoTest);
u16 rtl8188e_EfuseGetCurrentSize(PADAPTER pAdapter, u8 efuseType, BOOLEAN bPseudoTest);
int rtl8188e_Efuse_PgPacketRead(PADAPTER pAdapter, u8 offset, u8 *data, BOOLEAN bPseudoTest);
int rtl8188e_Efuse_PgPacketWrite(PADAPTER pAdapter, u8 offset, u8 word_en, u8 *data, BOOLEAN bPseudoTest);
u8 rtl8188e_Efuse_WordEnableDataWrite(PADAPTER pAdapter, u16 efuse_addr, u8 word_en, u8 *data, BOOLEAN bPseudoTest);
void rtl8188e_GetHalODMVar(PADAPTER Adapter, HAL_ODM_VARIABLE eVariable, PVOID pValue1, BOOLEAN bSet);
void rtl8188e_SetHalODMVar(PADAPTER Adapter, HAL_ODM_VARIABLE eVariable, PVOID pValue1, BOOLEAN bSet);
...
#define RTL8188E_HALFUNC_ANTENNA_DIVERSITY \
	.AntDivBeforeLinkHandler = AntDivBeforeLink8188E, \
	.AntDivCompareHandler = AntDivCompare8188E,
#else
#define RTL8188E_HALFUNC_ANTENNA_DIVERSITY
#endif

#ifdef DBG_CONFIG_ERROR_DETECT
#define RTL8188E_HALFUNC_ERROR_DETECT \
	.sreset_init_value = sreset_init_value, \
	.sreset_reset_value = sreset_reset_value, \
	.silentreset = sreset_reset, \
	.sreset_xmit_status_check = rtl8188e_sreset_xmit_status_check, \
	.sreset_linked_status_check  = rtl8188e_sreset_linked_status_check, \
...
#define RTL8188E_HALFUNC_XMIT_THREAD \
	.xmit_thread_handler = hal_xmit_handler,
#else
#define RTL8188E_HALFUNC_XMIT_THREAD
#endif

#ifdef CONFIG_IOL
#define RTL8188E_HALFUNC_IOL \
	.IOL_exec_cmds_sync = rtl8188e_IOL_exec_cmds_sync,
#else
#define RTL8188E_HALFUNC_IOL
#endif

#define RTL8188E_HALFUNC_COMMON \
	.free_hal_data = rtl8188e_free_hal_data, \
	.dm_init = rtl8188e_init_dm_priv, \
	.dm_deinit = rtl8188e_deinit_dm_priv, \
	.read_chip_version = rtl8188e_read_chip_version, \
	.set_bwmode_handler = PHY_SetBWMode8188E, \
	.set_channel_handler = PHY_SwChnl8188E, \
	.hal_dm_watchdog = rtl8188e_HalDmWatchDog, \
	.Add_RateATid = rtl8188e_Add_RateATid, \
	.run_thread= rtl8188e_start_thread, \
	.cancel_thread= rtl8188e_stop_thread, \
	RTL8188E_HALFUNC_ANTENNA_DIVERSITY \
	.read_bbreg = rtl8188e_PHY_QueryBBReg, \
	.write_bbreg = rtl8188e_PHY_SetBBReg, \
	.read_rfreg = rtl8188e_PHY_QueryRFReg, \
	.write_rfreg = rtl8188e_PHY_SetRFReg, \
	.EfusePowerSwitch = rtl8188e_EfusePowerSwitch, \
	.ReadEFuse = rtl8188e_ReadEFuse, \
	.EFUSEGetEfuseDefinition = rtl8188e_EFUSE_GetEfuseDefinition, \
	.EfuseGetCurrentSize = rtl8188e_EfuseGetCurrentSize, \
	.Efuse_PgPacketRead = rtl8188e_Efuse_PgPacketRead, \
	.Efuse_PgPacketWrite = rtl8188e_Efuse_PgPacketWrite, \
	.Efuse_WordEnableDataWrite = rtl8188e_Efuse_WordEnableDataWrite, \
	RTL8188E_HALFUNC_ERROR_DETECT \
	.GetHalODMVarHandler = rtl8188e_GetHalODMVar, \
	.SetHalODMVarHandler = rtl8188e_SetHalODMVar, \
	RTL8188E_HALFUNC_XMIT_THREAD \
	RTL8188E_HALFUNC_IOL \
	.hal_notch_filter = hal_notch_filter_8188e,
