	...
	)
{
	...
	if (AutoLoadFail)
	{
		copy_mac_addr(pEEPROM->mac_addr, (u8 []) {0x00, 0xE0, 0x4C, 0x81, 0x88, 0x77});
//		pEEPROM->mac_addr[5] = (u1Byte)GetRandomNumber(1, 254);		
	}
	else
	{
		//Read Permanent MAC address
		copy_mac_addr(pEEPROM->mac_addr, &hwinfo[EEPROM_MAC_ADDR_88ES]);
	}
...
//	if (OpMode == RT_OP_MODE_IBSS || OpMode == RT_OP_MODE_AP)
	if (check_fwstate(&padapter->mlmepriv, WIFI_ADHOC_STATE|WIFI_AP_STATE))
	{
...
static const struct hal_ops SDIOHalFunc = {
	RTL8188E_HALFUNC_COMMON

	.hal_power_on = InitPowerOn_rtl8188es,
	.hal_power_off = hal_poweroff_rtl8188es,

	.hal_init = rtl8188es_hal_init,
	.hal_deinit = rtl8188es_hal_deinit,

	.inirp_init = rtl8188es_inirp_init,
	.inirp_deinit = rtl8188es_inirp_deinit,

	.init_xmit_priv = rtl8188es_init_xmit_priv,
	.free_xmit_priv = rtl8188es_free_xmit_priv,

	.init_recv_priv = rtl8188es_init_recv_priv,
	.free_recv_priv = rtl8188es_free_recv_priv,

	.InitSwLeds = rtl8188es_InitSwLeds,
	.DeInitSwLeds = rtl8188es_DeInitSwLeds,

	.init_default_value = rtl8188es_init_default_value,
	.intf_chip_configure = rtl8188es_interface_configure,
	.read_adapter_info = ReadAdapterInfo8188ES,

	.enable_interrupt = EnableInterrupt8188ESdio,
	.disable_interrupt = DisableInterrupt8188ESdio,

#ifdef CONFIG_WOWLAN
	.clear_interrupt = ClearInterrupt8189ESdio,
#endif

	.SetHwRegHandler = SetHwReg8188ES,
	.GetHwRegHandler = GetHwReg8188ES,

	.GetHalDefVarHandler = GetHalDefVar8188ESDIO,
 	.SetHalDefVarHandler = SetHalDefVar8188ESDIO,

	.UpdateRAMaskHandler = UpdateHalRAMask8188ESdio,
	.SetBeaconRelatedRegistersHandler = SetBeaconRelatedRegisters8188ESdio,

	.hal_xmit = rtl8188es_hal_xmit,
	.mgnt_xmit = rtl8188es_mgnt_xmit,
	.hal_xmitframe_enqueue = rtl8188es_hal_xmitframe_enqueue,

#ifdef CONFIG_HOSTAPD_MLME
	.hostap_mgnt_xmit_entry = NULL,
//	.hostap_mgnt_xmit_entry = rtl8192cu_hostap_mgnt_xmit_entry,
#endif
};
