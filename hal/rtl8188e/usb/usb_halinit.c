...
_func_enter_;
	...
	if(!_read_interrupt(pintfhdl, RECV_INT_IN_ADDR))
	{
	...
	)
{
	...
	if(!AutoloadFail){
		...
		copy_mac_addr(pEEPROM->mac_addr, &PROMContent[EEPROM_MAC_ADDR]);
	}
	else{
		//Random assigh MAC address
		copy_mac_addr(pEEPROM->mac_addr, sMacAddr, (u8 []) {0x00, 0xE0, 0x4C, 0x81, 0x92, 0x00});
		//pEEPROM->mac_addr[5] = (u8)GetRandomNumber(1, 254);
	}
	...
	)
{
	...
	{ // autoload OK.
		...
		else
		{
			...
			memcpy((void*)PROMContent, (void*)pEEPROM->efuse_eeprom_data, HWSET_MAX_SIZE_88E);
		}
	}
	else
	{//autoload fail
	...
	)
{
	...
	if (AutoLoadFail)
	{
		copy_mac_addr(pEEPROM->mac_addr, (u8 []) {0x00, 0xE0, 0x4C, 0x81, 0x88, 0x02});
//		pEEPROM->mac_addr[5] = (u1Byte)GetRandomNumber(1, 254);
	}
	else
	{
		//Read Permanent MAC address
		copy_mac_addr(pEEPROM->mac_addr, &hwinfo[EEPROM_MAC_ADDR_88EU]);
	...
	)
{
	...
	set_zero_mac_addr(pEEPROM->mac_addr);
	...
	if (is_zero_mac_addr(pEEPROM->mac_addr) ||
		is_broadcast_mac_addr(pEEPROM->mac_addr)) {
...
static void hw_var_set_opmode(PADAPTER Adapter, u8 variable, u8* val)
{
	...
	if(Adapter->iface_type == IFACE_PORT1)
	{
		...
		else if(mode == _HW_STATE_AP_)
		{
			...
			if ( check_buddy_fwstate(Adapter, (WIFI_STATION_STATE|WIFI_ASOC_STATE)) ) {
				if (!reset_tsf(Adapter, IFACE_PORT1) )
...
#endif //CONFIG_CONCURRENT_MODE
	{
		...
		else if(mode == _HW_STATE_AP_)
		{
			...
			// Reset TSF for STA+AP concurrent mode
			if ( check_buddy_fwstate(Adapter, (WIFI_STATION_STATE|WIFI_ASOC_STATE)) ) {
				if (!reset_tsf(Adapter, IFACE_PORT0) )
		...
		case HW_VAR_WOWLAN:
		{
			...
			switch (poidparam->subcode){
				case WOWLAN_ENABLE:
					...
					//Set Pattern
					//if(adapter_to_pwrctl(Adapter)->wowlan_pattern)
...
static const struct hal_ops	USBHalFunc = {
	RTL8188E_HALFUNC_COMMON

	.hal_power_on = InitPowerOn_rtl8188eu,
	.hal_power_off = hal_poweroff_rtl8188eu,

	.hal_init = rtl8188eu_hal_init,
	.hal_deinit = rtl8188eu_hal_deinit,

	//.free_hal_data = rtl8192c_free_hal_data,

	.inirp_init = rtl8188eu_inirp_init,
	.inirp_deinit = rtl8188eu_inirp_deinit,

	.init_xmit_priv = rtl8188eu_init_xmit_priv,
	.free_xmit_priv = rtl8188eu_free_xmit_priv,

	.init_recv_priv = rtl8188eu_init_recv_priv,
	.free_recv_priv = rtl8188eu_free_recv_priv,
#ifdef CONFIG_SW_LED
	.InitSwLeds = rtl8188eu_InitSwLeds,
	.DeInitSwLeds = rtl8188eu_DeInitSwLeds,
	...
	.intf_chip_configure = rtl8188eu_interface_configure,
	.read_adapter_info = ReadAdapterInfo8188EU,
	...
	.SetHwRegHandler = SetHwReg8188EU,
	.GetHwRegHandler = GetHwReg8188EU,
  	.GetHalDefVarHandler = GetHalDefVar8188EUsb,
 	.SetHalDefVarHandler = SetHalDefVar8188EUsb,

	.UpdateRAMaskHandler = UpdateHalRAMask8188EUsb,
	.SetBeaconRelatedRegistersHandler = SetBeaconRelatedRegisters8188EUsb,

	//.Add_RateATid = rtl8192c_Add_RateATid,

	.hal_xmit = rtl8188eu_hal_xmit,
	.mgnt_xmit = rtl8188eu_mgnt_xmit,
	.hal_xmitframe_enqueue = rtl8188eu_hal_xmitframe_enqueue,

#ifdef CONFIG_HOSTAPD_MLME
	.hostap_mgnt_xmit_entry = rtl8188eu_hostap_mgnt_xmit_entry,
#endif
	.interface_ps_func = rtl8188eu_ps_func,
};
