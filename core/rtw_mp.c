...
static void _init_mp_priv_(struct mp_priv *pmp_priv)
{
	...
	copy_mac_addr(pmp_priv->network_macaddr, (u8 []) {0x00, 0xE0, 0x4C, 0x87, 0x66, 0x55});

	pnetwork = &pmp_priv->mp_network.network;
	copy_mac_addr(pnetwork->MacAddress, pmp_priv->network_macaddr);
...
//	memset(&bssid, 0, sizeof(WLAN_BSSID_EX));
	copy_mac_addr(bssid.MacAddress, pmppriv->network_macaddr);
